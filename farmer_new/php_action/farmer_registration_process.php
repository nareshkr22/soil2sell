...
require('../includes/files_include.php');
	...
	function getdata()
	{
		...
		$return_data = array($buyer_grpid,$buyer_name,$buyer_address,$buyer_village,$buyer_Taluka,$buyer_District,$buyer_type_of_chilly,$buyer_quntity,$price,$buyer_contact,$buyer_tag,$buyer_status);
		return $return_data;
