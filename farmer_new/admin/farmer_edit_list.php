...
$chk=$_GET['eid'];
		...
		$chk=$_GET['eid'];
		$exa=$conn->prepare('SELECT * FROM `db_product_data` WHERE  pd_uid=?');
		$exa->execute(array($chk));
		$exa->setFetchMode(PDO::FETCH_BOTH);
		$mid1=$exa->fetch();		
}
?>	
  ...
  <form class="form-horizontal" action="php_action_operation/farmer_edit_processing.php" method="post">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Vigha :</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter Price" name="usr_Vigha" value="<?php if(isset($_GET['edit'])){ echo $mid1['pd_vigha'];} ?>" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Seed Per Grap :</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter Price" name="usr_Seed" value="<?php if(isset($_GET['edit'])){ echo $mid1['pd_seed_gram'];} ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Remark :</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter Price" name="usr_remark" value="<?php if(isset($_GET['edit'])){ echo $mid1['pd_remak'];} ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Status Remark :</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter Price" name="usr_Status_Remark" value="<?php if(isset($_GET['edit'])){ echo $mid1['pd_status_remark'];} ?>">
      </div>
    </div>
