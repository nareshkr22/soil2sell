...
<body>
   ...
   <form action="php_action/farmer_registration_process.php" class="needs-validation" novalidate method="post">
    ...
    <!-- <div class="form-group">
      <label for="pwd">Vigha:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter price per quintal" name="usr_price" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
      <label for="pwd">Seed per Gram:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter price per quintal" name="usr_price" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div> -->
